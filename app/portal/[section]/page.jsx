...
export async function generateMetadata({ params }) { const { section } = await params; const titles = { results: "Mi nivel", courses: "Mis cursos", attendance: "Asistencia", payments: "Pagos", account: "Mi cuenta" }; return { title: `${titles[section] || "Portal"} | AIT USA Institute`, robots: { index: false, follow: false } }; }
