...
describe("MIS-341 authenticated portal view model", () => {
  it("builds a safe, action-first student dashboard", () => {
    ...
    assert.deepEqual(
      ...
      ["Inicio", "Mi nivel", "Mis cursos", "Asistencia", "Pagos", "Estudiar", "Cuenta"],
    );
    assert.deepEqual(
      model.navigation.map((item) => item.href),
      ["/portal/", "/portal/results/", "/portal/courses/", "/portal/attendance/", "/portal/payments/", "/portal/study/", "/portal/account/"],
    );
  });
