...
CREATE TABLE "ai_practice_sessions" (
  ...
  CONSTRAINT "ai_practice_sessions_provider_profile_check" CHECK (char_length("provider_profile") between 1 and 80),
...
CREATE TABLE "ai_practice_turn_operations" (
  ...
  CONSTRAINT "ai_practice_turn_operations_usage_check" CHECK ("input_units" >= 0 and "output_units" >= 0 and "charged_micro_usd" >= 0 and "reserved_micro_usd" > 0 and "charged_micro_usd" <= "reserved_micro_usd"),
